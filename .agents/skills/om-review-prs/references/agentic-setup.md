...
- Each individual review delegates the whole workflow to `om-auto-review-pr`, which loads the rest of the config (worktree, validation gate, label mutations) itself — do not pre-load or duplicate that here.
