...
outstanding review findings** — `om-auto-review-pr --autofix` owns both, in that
...
required checks: the hand-off to `om-approve-merge-pr` says what CI actually did, and
