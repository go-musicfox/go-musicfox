...
NSString * const MusicfoxNotifierBundleID = @"com.anhoder.musicfox-notifier";
...
- (NSString *)__bundleIdentifier;
{
  if (self == [NSBundle mainBundle]) {
    return _fakeBundleIdentifier ? _fakeBundleIdentifier : MusicfoxNotifierBundleID;
  } else {
...
- (void)printHelpBanner;
{
  ...
  printf("%s (%s) is a command-line tool to send macOS User Notifications.\n" \
         ...
         "       -version           Display muiscfox-notifier version.\n" \
         ...
         "\n" \
         "For more information see https://github.com/anhoder/go-musicfox.\n",
