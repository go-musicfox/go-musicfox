// Package configs loads and models musicfox configuration.
package configs
...
type CoverConfig struct {
	...
	// Batch placeholder updates to work around tmux combining-character bugs.
	TmuxSyncOutput bool `koanf:"tmuxSyncOutput"`
}
