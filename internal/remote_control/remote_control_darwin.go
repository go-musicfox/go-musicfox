...
func (s *RemoteControl) registerCommands() {
	...
	likeCmd := s.remoteCommandCenter.LikeCommand()
	likeCmd.SetEnabled(true)
	likeCmd.SetLocalizedTitle(core.String("喜欢"))
	likeCmd.SetLocalizedShortTitle(core.String("喜欢"))
	likeCmd.SetActive(true)
	likeCmd.AddTargetAction(s.commandHandler.ID, sel_handleLikeCommand)

	// dislikeCmd := s.remoteCommandCenter.DislikeCommand()
	// dislikeCmd.SetEnabled(true)
	// dislikeCmd.SetLocalizedTitle(core.String("不喜欢"))
	// dislikeCmd.SetLocalizedShortTitle(core.String("不喜欢"))
	// dislikeCmd.AddTargetAction(s.commandHandler.ID, sel_handleDislikeCommand)
	// dislikeCmd.SetActive(false)
