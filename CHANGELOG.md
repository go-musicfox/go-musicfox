...
<a name="v4.4.1"></a>
## [v4.4.1](https://github.com/go-musicfox/go-musicfox/compare/v4.4.0...v4.4.1) (2024-05-13)
...
* support env `RELEASE_TAG`,`GIT_REVISION`

### Feat

* update version.sh & fix windows control
* update scoop config

### Fix

* subscribe_list unresponsive


<a name="v4.4.0"></a>
## [v4.4.0](https://github.com/go-musicfox/go-musicfox/compare/v4.3.3...v4.4.0) (2024-05-12)

### Chore

* rename playing info `AsText`
* format
...
* append all songs of playlist to now playing list ([#232](https://github.com/go-musicfox/go-musicfox/issues/232))
* impl xesam:asText ([#202](https://github.com/go-musicfox/go-musicfox/issues/202))
* media player & smtc
* add win media player [#246](https://github.com/go-musicfox/go-musicfox/issues/246)
* update win media player
* [#196](https://github.com/go-musicfox/go-musicfox/issues/196)
...
* notificator panic
* smtc with beep
* opening the QR code image fails when the MUSICFOX_ROOT environment variable is set in Windows
* upgrade deps
* defer ignore
...
* media player command manager

### Refactor

* project layout & fix some bugs
